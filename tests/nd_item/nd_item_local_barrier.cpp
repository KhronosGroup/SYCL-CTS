...
void test_barrier(util::logger & log, cl::sycl::queue &queue)
{
    ...
    /* run kernel to swap adjancent work item's global id*/
    {
        ...
        queue.submit( [&]( handler& cgh )
        {
            ...
            accessor<int, 1, cl::sycl::access::mode::read_write, cl::sycl::access::target::local> localScratch( localRange, cgh );

            cgh.parallel_for<class local_barrier_kernel>(NDRange, [=](nd_item<1> item)
            {
