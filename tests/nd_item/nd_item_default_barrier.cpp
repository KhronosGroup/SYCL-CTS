...
template <int dim>
struct barrierCall {
  void operator()(sycl::nd_item<dim> item) const { item.barrier(); }
};
...
class TEST_NAME : public util::test_base {
 public:
  ...
  void run(util::logger &log) override {
    ...
    std::string errorMsg = "default barrier failed for local address space";
    ...
    errorMsg = "default barrier failed for global address space";
