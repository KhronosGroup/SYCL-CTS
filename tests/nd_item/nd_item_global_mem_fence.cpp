...
//
//  Provides coverage for global mem_fence
//
*******************************************************************************/
...
#define TEST_NAME nd_item_global_mem_fence

namespace nd_item_global_mem_fence__ {
...
void test_mem_fence(util::logger &log, cl::sycl::queue &queue) {
  const auto fenceSpace = cl::sycl::access::fence_space::global_space;
