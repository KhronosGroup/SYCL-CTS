 ...
 public:
  ...
  void test_equality(util::logger& log) {
    try {
      ...
      // nd_item is not default constructible, store two objects
      ...
      // First store two instances of nd_item into the array
      {
        ...
        // Retrieve two nd_item objects and store them
        ...
        testQueue.submit([&](cl::sycl::handler& cgh) {
          ...
          cgh.parallel_for<nd_item_setup_kernel<numDims>>(
        ...
        // Perform comparisons on the stored nd_item objects
        ...
        testQueue.submit([&](cl::sycl::handler& cgh) {
          ...
          cgh.single_task<nd_item_equality_kernel<numDims>>([=]() {
      ...
      // Check nd_item equality operator
