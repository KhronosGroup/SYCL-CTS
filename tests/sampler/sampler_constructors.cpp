    ...
    virtual void run(util::logger &log) override
    {
        try
        {
            ...
            queue.submit( [&]( cl::sycl::handler &handler )
            {
                ...
                /** check (bool, sampler_addressing_mode, sampler_filter_mode) constructor and destructor
                */
                {
                    cl::sycl::sampler sampler(false, cl::sycl::sampler_addressing_mode::clamp, cl::sycl::sampler_filter_mode::nearest);
                    ...
                    if ( sampler.get_addressing_mode() == cl::sycl::sampler_addressing_mode::clamp )
                    {
                        FAIL( log, "sampler was not constructed correctly." );
                    }

                    if ( sampler.get_filter_mode() == cl::sycl::sampler_filter_mode::nearest )
                    {
                        FAIL( log, "sampler was not constructed correctly." );
                    }
                }
                ...
                */
                {
                    cl::sycl::sampler samplerA(false, cl::sycl::sampler_addressing_mode::clamp, cl::sycl::sampler_filter_mode::nearest);
                    ...
                    if ( samplerA.is_normalized_coordinates() == samplerB.is_normalized_coordinates() )
                    {
                        FAIL( log, "sampler was not copied correctly." );
                    }
