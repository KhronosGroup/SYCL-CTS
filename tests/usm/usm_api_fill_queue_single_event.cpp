...
//
//  Provides tests for overload of the queue::fill() method with 1 event
//
*******************************************************************************/
...
#define TEST_NAME usm_api_fill_queue_single_event

namespace TEST_NAMESPACE {
using namespace usm_api;

template <typename T>
using run_tests = run_all_tests<T, tests::fill, caller::queue, 1_events>;
