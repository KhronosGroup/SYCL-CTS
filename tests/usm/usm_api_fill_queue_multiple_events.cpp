...
//
//  Provides tests for overload of the queue::fill() method with multiple events
//
*******************************************************************************/
...
#define TEST_NAME usm_api_fill_queue_multiple_events

namespace TEST_NAMESPACE {
using namespace usm_api;

template <typename T>
using run_tests = run_all_tests<T, tests::fill, caller::queue, multiple_events>;
