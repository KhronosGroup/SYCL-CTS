...
#define TEST_NAME math_relational_binary_isordered_$NUM_ELMS$
#define TEST_FUNC isordered
#define KERNEL_NAME cKernel_isordered

namespace math_relational_binary_isordered__ {
