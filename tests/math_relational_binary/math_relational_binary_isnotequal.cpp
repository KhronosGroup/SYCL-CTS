...
#define TEST_NAME math_relational_binary_isnotequal_$NUM_ELMS$
#define TEST_FUNC isnotequal
#define KERNEL_NAME cKernel_isnotequal

namespace math_relational_binary_isnotequal__ {
