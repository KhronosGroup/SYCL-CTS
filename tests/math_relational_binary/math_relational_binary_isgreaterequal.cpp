...
#define TEST_NAME math_relational_binary_isgreaterequal_$NUM_ELMS$
#define TEST_FUNC isgreaterequal
#define KERNEL_NAME cKernel_isgreaterequal

namespace math_relational_binary_isgreaterequal__ {
