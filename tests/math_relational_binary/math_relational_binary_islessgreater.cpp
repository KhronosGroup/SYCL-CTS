...
#define TEST_NAME math_relational_binary_islessgreater_$NUM_ELMS$
#define TEST_FUNC islessgreater
#define KERNEL_NAME cKernel_islessgreater

namespace math_relational_binary_islessgreater__ {
