...
#define TEST_NAME math_relational_binary_isunordered_$NUM_ELMS$
#define TEST_FUNC isunordered
#define KERNEL_NAME cKernel_isunordered

namespace math_relational_binary_isunordered__ {
