...
#define TEST_NAME math_relational_binary_isgreater_$NUM_ELMS$
#define TEST_FUNC isgreater
#define KERNEL_NAME cKernel_isgreater

namespace math_relational_binary_isgreater__ {
