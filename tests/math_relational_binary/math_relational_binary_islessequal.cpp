...
#define TEST_NAME math_relational_binary_islessequal_$NUM_ELMS$
#define TEST_FUNC islessequal
#define KERNEL_NAME cKernel_islessequal

namespace math_relational_binary_islessequal__ {
