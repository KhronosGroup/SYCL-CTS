...
#define TEST_NAME    math_relational_binary_isequal_$NUM_ELMS$
#define TEST_FUNC    isequal
#define KERNEL_NAME  cKernel_isequal

namespace math_relational_binary_isequal__
{
