 ...
 public:
  ...
  void run(util::logger &log) override {
    test_function<0, float>([=]() {
      ...
      return cl::sycl::native::cos(inputData_0);
    ...
    test_function<3, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.7270388712, 0.3426501809, 0.4812775633,
                                   0.5667056316);
      return cl::sycl::native::cos(inputData_0);
    ...
    test_function<4, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.8264903082, 0.5037494847, 0.3254702755,
                                   0.7046433633, 0.5946951973, 0.3004050731,
                                   0.8277970048, 0.8862283808);
      return cl::sycl::native::cos(inputData_0);
    ...
    test_function<5, cl::sycl::float16>([=]() {
      cl::sycl::float16 inputData_0(
          0.7481737888, 0.8217327604, 0.3481180555, 0.6838653986, 0.8190706304,
          0.6471871455, 0.4777141724, 0.1805609665, 0.4473374684, 0.5887095788,
          0.8304088426, 0.8732850942, 0.4816078212, 0.7922479422, 0.3083938483,
          0.7440222616);
      return cl::sycl::native::cos(inputData_0);
    ...
    test_function<6, float>([=]() {
      ...
      return cl::sycl::native::divide(inputData_0, inputData_1);
    ...
    test_function<9, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.2528536732, 0.5540085925, 0.2908927429,
                                   0.8740322002);
      cl::sycl::float4 inputData_1(0.7425435754, 0.4583756571, 0.1643566548,
                                   0.3560436837);
      return cl::sycl::native::divide(inputData_0, inputData_1);
    ...
    test_function<10, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.506352514, 0.8462670594, 0.1872462767,
                                   0.5410137969, 0.6652491279, 0.5379527291,
                                   0.7515734906, 0.5322268856);
      cl::sycl::float8 inputData_1(0.8710708368, 0.5825485024, 0.5700936513,
                                   0.455991221, 0.5770294893, 0.4079209168,
                                   0.5605208113, 0.3322636019);
      return cl::sycl::native::divide(inputData_0, inputData_1);
    ...
    test_function<11, cl::sycl::float16>([=]() {
      cl::sycl::float16 inputData_0(
          ...
          0.171859489, 0.7060831376, 0.8014162967, 0.8387048128, 0.7739681785,
          0.8185384971, 0.8384659519, 0.53247994, 0.4130368402, 0.6642267199,
          0.320507297);
    ...
    test_function<12, float>([=]() {
      ...
      return cl::sycl::native::exp(inputData_0);
    ...
    test_function<15, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.7527304772, 0.1804860162, 0.2170867911,
                                   0.6581365122);
      return cl::sycl::native::exp(inputData_0);
    ...
    test_function<16, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.1361872543, 0.5590928294, 0.8280128118,
                                   0.5273583746, 0.644471306, 0.1213574357,
                                   0.6079999279, 0.5850707342);
      return cl::sycl::native::exp(inputData_0);
    ...
    test_function<18, float>([=]() {
      ...
      return cl::sycl::native::exp2(inputData_0);
    ...
    test_function<21, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.180736993, 0.890588119, 0.2594846324,
                                   0.386844241);
      return cl::sycl::native::exp2(inputData_0);
    ...
    test_function<22, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.685278645, 0.7706612522, 0.8347856496,
                                   0.2355396849, 0.6381124509, 0.8732391224,
                                   0.1464407551, 0.6409614274);
      return cl::sycl::native::exp2(inputData_0);
    ...
    test_function<23, cl::sycl::float16>([=]() {
      cl::sycl::float16 inputData_0(
          0.776339675, 0.3738500329, 0.3005498714, 0.5774331148, 0.453851227,
    ...
    test_function<24, float>([=]() {
      ...
      return cl::sycl::native::exp10(inputData_0);
    ...
    test_function<27, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.3817804492, 0.3303023319, 0.3873609578,
                                   0.8575246685);
      return cl::sycl::native::exp10(inputData_0);
    ...
    test_function<28, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.6069982818, 0.5968614765, 0.6724954802,
    ...
    test_function<30, float>([=]() {
      ...
      return cl::sycl::native::log(inputData_0);
    ...
    test_function<33, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.4735137883, 0.7472366859, 0.8000130652,
                                   0.7499319459);
      return cl::sycl::native::log(inputData_0);
    ...
    test_function<34, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.2504010352, 0.8995362876, 0.6064710079,
                                   0.1667736401, 0.6804434844, 0.8894571842,
                                   0.4214534578, 0.6428120042);
      return cl::sycl::native::log(inputData_0);
    ...
    test_function<35, cl::sycl::float16>([=]() {
      cl::sycl::float16 inputData_0(
          0.3529417098, 0.2708197297, 0.6738593146, 0.1018860518, 0.7581851284,
          0.5226767815, 0.1782274734, 0.1951231158, 0.6194123399, 0.7989230591,
          0.3239861947, 0.8828121494, 0.1801445513, 0.7831504877, 0.4173569419,
          0.1650763334);
      return cl::sycl::native::log(inputData_0);
    ...
    test_function<36, float>([=]() {
      ...
      return cl::sycl::native::log2(inputData_0);
    ...
    test_function<39, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.6206265905, 0.3776424117, 0.7974910686,
                                   0.3227278522);
      return cl::sycl::native::log2(inputData_0);
    ...
    test_function<40, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.114859462, 0.1325306189, 0.6447974161,
                                   0.5466845889, 0.8572020433, 0.8507510398,
                                   0.8278809419, 0.1336036256);
      return cl::sycl::native::log2(inputData_0);
    ...
    test_function<42, float>([=]() {
      ...
      return cl::sycl::native::log10(inputData_0);
    ...
    test_function<45, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.5387874373, 0.3347256012, 0.4824517353,
                                   0.2917648669);
      return cl::sycl::native::log10(inputData_0);
    ...
    test_function<46, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.1386050898, 0.2436694792, 0.5184401854,
    ...
    test_function<48, float>([=]() {
      ...
      return cl::sycl::native::powr(inputData_0, inputData_1);
    ...
    test_function<51, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.3946651651, 0.8907672465, 0.3087332284,
                                   0.7216801236);
      cl::sycl::float4 inputData_1(0.4449768197, 0.3868163056, 0.1510863592,
                                   0.7908631554);
      return cl::sycl::native::powr(inputData_0, inputData_1);
    ...
    test_function<52, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.6616033198, 0.822408566, 0.4612894341,
                                   0.6415367735, 0.1951282292, 0.4183628813,
                                   0.2657855787, 0.1336811423);
      cl::sycl::float8 inputData_1(0.858369081, 0.2727154948, 0.2170835918,
                                   0.2583760348, 0.4024255715, 0.5371130099,
                                   0.2210674948, 0.8909519112);
      return cl::sycl::native::powr(inputData_0, inputData_1);
    ...
    test_function<53, cl::sycl::float16>([=]() {
      cl::sycl::float16 inputData_0(
          0.8863913684, 0.2187216137, 0.4247255065, 0.6439435865, 0.8021252663,
          0.4963247399, 0.8336373382, 0.3579682519, 0.4987527132, 0.4989172735,
          0.6360545211, 0.261593047, 0.5878164883, 0.2750184775, 0.372176252,
          0.8700531706);
      cl::sycl::float16 inputData_1(
          0.8192064304, 0.7544947047, 0.1283746095, 0.218693506, 0.3055055297,
          0.7273332546, 0.7738666617, 0.5663585442, 0.6745053214, 0.745644304,
          0.1530873048, 0.1677145095, 0.7951162512, 0.1315326635, 0.2800725229,
          0.1325056213);
      return cl::sycl::native::powr(inputData_0, inputData_1);
    ...
    test_function<54, float>([=]() {
      ...
      return cl::sycl::native::recip(inputData_0);
    ...
    test_function<57, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.8748786174, 0.5039997541, 0.8208723815,
                                   0.5019428792);
      return cl::sycl::native::recip(inputData_0);
    ...
    test_function<58, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.559097982, 0.6428570854, 0.7440879912,
    ...
    test_function<60, float>([=]() {
      ...
      return cl::sycl::native::rsqrt(inputData_0);
    ...
    test_function<63, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.2018566503, 0.329670672, 0.7639525493,
                                   0.1444216367);
      return cl::sycl::native::rsqrt(inputData_0);
    ...
    test_function<64, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.1287470667, 0.4342928358, 0.4934647673,
                                   0.7906601465, 0.6737509971, 0.6388350469,
                                   0.2210990179, 0.8893647394);
      return cl::sycl::native::rsqrt(inputData_0);
    ...
    test_function<65, cl::sycl::float16>([=]() {
      cl::sycl::float16 inputData_0(
          0.428912157, 0.5894166915, 0.4093464044, 0.1376263326, 0.4767113672,
          0.2210942031, 0.1259723699, 0.5939203389, 0.603973033, 0.1842342597,
          0.539315013, 0.3773343813, 0.4067312585, 0.721135919, 0.492255742,
          0.8050212923);
      return cl::sycl::native::rsqrt(inputData_0);
    ...
    test_function<66, float>([=]() {
      ...
      return cl::sycl::native::sin(inputData_0);
    ...
    test_function<69, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.5976299542, 0.7308531931, 0.2016873,
                                   0.8294266545);
      return cl::sycl::native::sin(inputData_0);
    ...
    test_function<70, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.7394729691, 0.8335099265, 0.7980277774,
                                   0.6448051571, 0.7482006795, 0.5152058474,
                                   0.7283913195, 0.2513019743);
      return cl::sycl::native::sin(inputData_0);
    ...
    test_function<72, float>([=]() {
      ...
      return cl::sycl::native::sqrt(inputData_0);
    ...
    test_function<75, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.4407761985, 0.5528103794, 0.8383044665,
                                   0.8486038155);
      return cl::sycl::native::sqrt(inputData_0);
    ...
    test_function<76, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.4325129572, 0.1793687905, 0.719054986,
    ...
    test_function<78, float>([=]() {
      ...
      return cl::sycl::native::tan(inputData_0);
    ...
    test_function<81, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.7873404869, 0.2495933619, 0.1899128287,
                                   0.3755596859);
      return cl::sycl::native::tan(inputData_0);
    ...
    test_function<82, cl::sycl::float8>([=]() {
      cl::sycl::float8 inputData_0(0.8673372165, 0.2041261555, 0.8732154084,
                                   0.389791896, 0.4786963222, 0.3341055888,
                                   0.8497014754, 0.866518316);
      return cl::sycl::native::tan(inputData_0);
