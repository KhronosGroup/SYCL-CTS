...
def create_types():
    ...
    t_float_1 = argtype("cl::sycl::float1", "vector", "float", 1, [])
    type_dic["cl::sycl::float1"] = t_float_1
    ...
    t_double_1 = argtype("cl::sycl::double1", "vector", "double", 1, [])
    type_dic["cl::sycl::double1"] = t_double_1
    ...
    t_half_1 = argtype("cl::sycl::half1", "vector", "cl::sycl::half", 1, [])
    type_dic["cl::sycl::half1"] = t_half_1
    ...
    t_char_1 = argtype("cl::sycl::char1", "vector", "char", 1, [])
    type_dic["cl::sycl::char1"] = t_char_1
    ...
    t_schar_1 = argtype("cl::sycl::schar1", "vector", "char", 1, [])
    type_dic["cl::sycl::schar1"] = t_schar_1
    ...
    t_uchar_1 = argtype("cl::sycl::uchar1", "vector", "char", 1, [], True)
    type_dic["cl::sycl::uchar1"] = t_uchar_1
    ...
    t_short_1 = argtype("cl::sycl::short1", "vector", "short", 1, [])
    type_dic["cl::sycl::short1"] = t_short_1
    ...
    t_ushort_1 = argtype("cl::sycl::ushort1", "vector", "short", 1, [], True)
    type_dic["cl::sycl::ushort1"] = t_ushort_1
    ...
    t_int_1 = argtype("cl::sycl::int1", "vector", "int", 1, [])
    type_dic["cl::sycl::int1"] = t_int_1
    ...
    t_uint_1 = argtype("cl::sycl::uint1", "vector", "int", 1, [], True)
    type_dic["cl::sycl::uint1"] = t_uint_1
    ...
    t_long_1 = argtype("cl::sycl::long1", "vector", "long int", 1, [])
    type_dic["cl::sycl::long1"] = t_long_1
    ...
    t_ulong_1 = argtype("cl::sycl::ulong1", "vector", "long int", 1, [], True)
    type_dic["cl::sycl::ulong1"] = t_ulong_1
    ...
    t_longlong_1 = argtype("cl::sycl::longlong1", "vector", "long long int", 1, [])
    type_dic["cl::sycl::longlong1"] = t_longlong_1
    ...
    t_ulonglong_1 = argtype("cl::sycl::ulonglong1", "vector", "long long int", 1, [], True)
    type_dic["cl::sycl::ulonglong1"] = t_ulonglong_1
    ...
    t_float_n = argtype("floatn", "NULL", "NULL", 0, ["cl::sycl::float1","cl::sycl::float2","cl::sycl::float3","cl::sycl::float4","cl::sycl::float8","cl::sycl::float16"])
    type_dic["floatn"] = t_float_n
    
    t_gen_float_f = argtype("genfloatf", "NULL", "NULL", 0, ["float", "floatn"])
    type_dic["genfloatf"] = t_gen_float_f

    t_double_n = argtype("doublen", "NULL", "NULL", 0, ["cl::sycl::double1","cl::sycl::double2","cl::sycl::double3","cl::sycl::double4","cl::sycl::double8","cl::sycl::double16"])
    type_dic["doublen"] = t_double_n
    
    t_gen_float_d = argtype("genfloatd", "NULL", "NULL", 0, ["double","doublen"])
    type_dic["genfloatd"] = t_gen_float_d
    
    t_half_n = argtype("halfn", "NULL", "NULL", 0, ["cl::sycl::half1","cl::sycl::half2","cl::sycl::half3","cl::sycl::half4","cl::sycl::half8","cl::sycl::half16"])
    ...
    t_char_n = argtype("charn", "NULL", "NULL", 0, ["cl::sycl::char1","cl::sycl::char2","cl::sycl::char3","cl::sycl::char4","cl::sycl::char8","cl::sycl::char16"])
    type_dic["charn"] = t_char_n

    t_schar_n = argtype("scharn", "NULL", "NULL", 0, ["cl::sycl::schar1","cl::sycl::schar2","cl::sycl::schar3","cl::sycl::schar4","cl::sycl::schar8","cl::sycl::schar16"])
    type_dic["scharn"] = t_schar_n

    t_uchar_n = argtype("ucharn", "NULL", "NULL", 0, ["cl::sycl::uchar1","cl::sycl::uchar2","cl::sycl::uchar3","cl::sycl::uchar4","cl::sycl::uchar8","cl::sycl::uchar16"])
    ...
    t_short_n = argtype("shortn", "NULL", "NULL", 0, ["cl::sycl::short1","cl::sycl::short2","cl::sycl::short3","cl::sycl::short4","cl::sycl::short8","cl::sycl::short16"])
    type_dic["shortn"] = t_short_n 
    
    t_gen_short = argtype("genshort", "NULL", "NULL", 0, ["short","shortn"])
    type_dic["genshort"] = t_gen_short
    
    t_ushort_n = argtype("ushortn", "NULL", "NULL", 0, ["cl::sycl::ushort1","cl::sycl::ushort2","cl::sycl::ushort3","cl::sycl::ushort4","cl::sycl::ushort8","cl::sycl::ushort16"])
    ...
    t_uint_n = argtype("uintn", "NULL", "NULL", 0, ["cl::sycl::uint1","cl::sycl::uint2","cl::sycl::uint3","cl::sycl::uint4","cl::sycl::uint8","cl::sycl::uint16"])
    type_dic["uintn"] = t_uint_n

    t_ugen_int = argtype("ugenint", "NULL", "NULL", 0, ["unsigned int","uintn"])
    type_dic["ugenint"] = t_ugen_int

    t_int_n = argtype("intn", "NULL", "NULL", 0, ["cl::sycl::int1","cl::sycl::int2","cl::sycl::int3","cl::sycl::int4","cl::sycl::int8","cl::sycl::int16"])
    type_dic["intn"] = t_int_n

    t_gen_int = argtype("genint", "NULL", "NULL", 0, ["int","intn"])
    type_dic["genint"] = t_gen_int

    t_ulong_n = argtype("ulongn", "NULL", "NULL", 0, ["cl::sycl::ulong1","cl::sycl::ulong2","cl::sycl::ulong3","cl::sycl::ulong4","cl::sycl::ulong8","cl::sycl::ulong16"])
    type_dic["ulongn"] = t_ulong_n

    t_ugen_long = argtype("ugenlong", "NULL", "NULL", 0, ["unsigned long int", "ulongn"])
    type_dic["ugenlong"] = t_ugen_long

    t_long_n = argtype("longn", "NULL", "NULL", 0, ["cl::sycl::long1","cl::sycl::long2","cl::sycl::long3","cl::sycl::long4","cl::sycl::long8","cl::sycl::long16"])
    type_dic["longn"] = t_long_n

    t_gen_long = argtype("genlong", "NULL", "NULL", 0, ["long int", "longn"])
    type_dic["genlong"] = t_gen_long

    t_ulonglong_n = argtype("ulonglongn", "NULL", "NULL", 0, ["cl::sycl::ulonglong1","cl::sycl::ulonglong2","cl::sycl::ulonglong3","cl::sycl::ulonglong4","cl::sycl::ulonglong8","cl::sycl::ulonglong16"])
    ...
    t_longlong_n = argtype("longlongn", "NULL", "NULL", 0, ["cl::sycl::longlong1","cl::sycl::longlong2","cl::sycl::longlong3","cl::sycl::longlong4","cl::sycl::longlong8","cl::sycl::longlong16"])
