...
class TEST_NAME : public util::test_base {
 public:
  ...
  void run(util::logger &log) override {
    test_function<0, cl::sycl::float3>([=]() {
    ...
    test_function<1, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.7270388712, 0.3426501809, 0.4812775633,
                                   0.5667056316);
      cl::sycl::float4 inputData_1(0.8264903082, 0.5037494847, 0.3254702755,
                                   0.7046433633);
      return cl::sycl::cross(inputData_0, inputData_1);
    ...
    test_function<3, cl::sycl::double4>([=]() {
      cl::sycl::double4 inputData_0(0.3481180555, 0.6838653986, 0.8190706304,
                                    0.6471871455);
      cl::sycl::double4 inputData_1(0.4777141724, 0.1805609665, 0.4473374684,
                                    0.5887095788);
      return cl::sycl::cross(inputData_0, inputData_1);
    ...
    test_function<7, float>([=]() {
      cl::sycl::float4 inputData_0(0.1009142555, 0.4948622932, 0.7940822204,
                                   0.2951287015);
      cl::sycl::float4 inputData_1(0.3601634902, 0.7963769857, 0.2528536732,
                                   0.5540085925);
      return cl::sycl::dot(inputData_0, inputData_1);
    ...
    test_function<11, double>([=]() {
      cl::sycl::double4 inputData_0(0.7515734906, 0.5322268856, 0.8710708368,
                                    0.5825485024);
      cl::sycl::double4 inputData_1(0.5700936513, 0.455991221, 0.5770294893,
                                    0.4079209168);
      return cl::sycl::dot(inputData_0, inputData_1);
    ...
    test_function<15, float>([=]() {
      cl::sycl::float4 inputData_0(0.8185384971, 0.8384659519, 0.53247994,
                                   0.4130368402);
      cl::sycl::float4 inputData_1(0.6642267199, 0.320507297, 0.7493029668,
                                   0.7795887721);
      return cl::sycl::distance(inputData_0, inputData_1);
    ...
    test_function<19, double>([=]() {
      cl::sycl::double4 inputData_0(0.6041178723, 0.7760620605, 0.2944284976,
                                    0.6851913766);
      cl::sycl::double4 inputData_1(0.1937074346, 0.2763684295, 0.7356663774,
                                    0.3660289194);
      return cl::sycl::distance(inputData_0, inputData_1);
    ...
    test_function<23, float>([=]() {
      cl::sycl::float4 inputData_0(0.8280128118, 0.5273583746, 0.644471306,
                                   0.1213574357);
      return cl::sycl::length(inputData_0);
    ...
    test_function<27, double>([=]() {
      cl::sycl::double4 inputData_0(0.1291136301, 0.1173092079, 0.8688250242,
                                    0.2479775531);
      return cl::sycl::length(inputData_0);
    ...
    test_function<31, cl::sycl::double4>([=]() {
      cl::sycl::double4 inputData_0(0.1812001755, 0.3079359118, 0.2766634171,
                                    0.6175405759);
      return cl::sycl::normalize(inputData_0);
    ...
    test_function<35, float>([=]() {
      cl::sycl::float4 inputData_0(0.6381124509, 0.8732391224, 0.1464407551,
                                   0.6409614274);
      cl::sycl::float4 inputData_1(0.776339675, 0.3738500329, 0.3005498714,
                                   0.5774331148);
      return cl::sycl::fast_distance(inputData_0, inputData_1);
    ...
    test_function<39, float>([=]() {
      cl::sycl::float4 inputData_0(0.3491568008, 0.3857213461, 0.7701289395,
                                   0.3007461319);
      return cl::sycl::fast_length(inputData_0);
    ...
    test_function<43, cl::sycl::float4>([=]() {
      cl::sycl::float4 inputData_0(0.2921043263, 0.8625034719, 0.3817804492,
                                   0.3303023319);
      return cl::sycl::fast_normalize(inputData_0);
