 ...
 public:
  ...
  void run(util::logger &log) override {
    ...
    if (!check_type_min_size<char>(1)) {
      FAIL(log, "The following host type does not have the correct size: char");
    }
    check_type_min_size_sign_log<unsigned char>(log, 1, false, "unsigned char");
    ...
    check_type_min_size_sign_log<long long int>(log, 8, true, "long long int");
