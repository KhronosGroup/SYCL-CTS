...
class TEST_NAME : public util::test_base {
 public:
  ...
  void run(util::logger &log) override {
    ...
    check_type_min_size_sign_log<sycl::cl_bool>(log, 1, false, "sycl::cl_bool");
    check_type_min_size_sign_log<sycl::cl_char>(log, 1, true, "sycl::cl_char");
    ...
    check_type_min_size_sign_log<sycl::cl_ushort>(log, 2, false,
                                                  "sycl::cl_ushort");
    check_type_min_size_sign_log<sycl::cl_int>(log, 4, true, "sycl::cl_int");
    check_type_min_size_sign_log<sycl::cl_uint>(log, 4, false, "sycl::cl_uint");
    check_type_min_size_sign_log<sycl::cl_long>(log, 8, true, "sycl::cl_long");
    check_type_min_size_sign_log<sycl::cl_ulong>(log, 8, false,
                                                 "sycl::cl_ulong");

    // Floating Point Interop Data Types
    check_type_min_size_sign_log<sycl::cl_half>(log, 2, true, "sycl::cl_half");
