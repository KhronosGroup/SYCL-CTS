...
//  scalar and bool variables types without identity param.
//
*******************************************************************************/
...
namespace reduction_without_identity_param_no_one_item_core {
...
void run_test_for_bool_variable(RangeT& range, sycl::queue& queue) {
  run_test_for_all_reductions_types<bool, reduction_get_lambda::with_combine,
                                    ...
                                    test_case_type::no_one_work_item>(
...
void run_all_core_tests(RangeT& range, sycl::queue& queue) {
  for_all_types<run_tests_for_all_functors_no_one_item, UsePropertyFlagT>(
  ...
  if constexpr (!UsePropertyFlagT::value) {
    ...
    run_test_for_all_reductions_types<
        ...
        UsePropertyFlagT::value, test_case_type::no_one_work_item>(
...
("reduction_without_identity_param_no_one_item_core", "[reduction]")({
