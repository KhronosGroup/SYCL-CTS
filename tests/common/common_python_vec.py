...
class Data:
    ...
    opencl_types = [
        ...
        'cl::sycl::cl_double',
        'cl::sycl::cl_half']
    opencl_type_dict = {(False, 'cl::sycl::cl_char'): 'cl::sycl::cl_uchar',
    ...
    swizzle_xyzw_list_dict = {1: ['x'],
                              2: ['x', 'y'],
                              3: ['x', 'y', 'z'],
                              4: ['x', 'y', 'z', 'w']}
    swizzle_rgba_list_dict = {1: ['r'],
                              2: ['r', 'g'],
                              3: ['r', 'g', 'b'],
                              4: ['r', 'g', 'b', 'a']}
    swizzle_elem_list_dict = {1: ['cl::sycl::elem::s0'],
                              2: ['cl::sycl::elem::s0',
                                  'cl::sycl::elem::s1'],
                              3: ['cl::sycl::elem::s0',
                                  'cl::sycl::elem::s1',
...
kernel_start_template = Template("""  bool resArray[1] = {true};
  {
...
def wrap_with_half_check(type_str, test_string):
...
def append_fp_postfix(type_str, input_val_list):
    ...
    for val in input_val_list:
        if (type_str == 'float' or type_str == 'cl::sycl::cl_float' or type_str ==
                'cl::sycl::half' or type_str == 'cl::sycl::cl_half'):
...
def swap_pairs(input_list):
    ...
    if len(input_list) % 2 == 0:
        ...
        return_list[:len(input_list) -
                    1:2], return_list[1:len(input_list) -
                                      1:2] = input_list[1:len(input_list) -
                                                        1:2], input_list[:len(input_list) -
                                                                         1:2]
    return return_list
...
def replace_string_in_source_string(
        source,
        generated_tests,
        replacement_string):
