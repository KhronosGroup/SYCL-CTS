...
def make_tests(input_file, output_file):
    ...
    swizzles = [None] * 6
    swizzles[0] = gen_swizzle_test('char', 'char', 'char', 1)
    swizzles[1] = gen_swizzle_test('char', 'char', 'char', 2)
    swizzles[2] = gen_swizzle_test('char', 'char', 'char', 3)
    swizzles[3] = gen_swizzle_test('char', 'char', 'char', 4)
    swizzles[4] = gen_swizzle_test('char', 'char', 'char', 8)
    swizzles[5] = gen_swizzle_test('char', 'char', 'char', 16)

    write_source_file(swizzles, input_file, output_file, 'char')
