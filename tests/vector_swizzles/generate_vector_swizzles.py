...
from common_python_vec import (Data, ReverseData, replace_string_in_source_string,
...
def get_reverse_type(type_str):
    if type_str == 'char':
        return 'char'
    (sign, base_type) = ReverseData.rev_standard_type_dict[type_str]
    if (not sign, base_type) in Data.standard_type_dict:
