 ...
 public:
  ...
  void operator()() {
    ...
    */
    ...
    old = a.fetch_and(static_cast<T>(1));
    old = a.fetch_or(static_cast<T>(1));
    old = a.fetch_xor(static_cast<T>(1));
    old = a.fetch_min(static_cast<T>(1));
    old = a.fetch_max(static_cast<T>(1));
    ...
    */
    ...
    old = a.fetch_and(static_cast<T>(1), order);
    old = a.fetch_or(static_cast<T>(1), order);
    old = a.fetch_xor(static_cast<T>(1), order);
    old = a.fetch_min(static_cast<T>(1), order);
    old = a.fetch_max(static_cast<T>(1), order);
    ...
    */
    ...
    old = cl::sycl::atomic_fetch_and(a, static_cast<T>(1));
    old = cl::sycl::atomic_fetch_or(a, static_cast<T>(1));
    old = cl::sycl::atomic_fetch_xor(a, static_cast<T>(1));
    old = cl::sycl::atomic_fetch_min(a, static_cast<T>(1));
    old = cl::sycl::atomic_fetch_max(a, static_cast<T>(1));
    ...
    */
    ...
    old = cl::sycl::atomic_fetch_and(a, static_cast<T>(1), order);
    old = cl::sycl::atomic_fetch_or(a, static_cast<T>(1), order);
    old = cl::sycl::atomic_fetch_xor(a, static_cast<T>(1), order);
    old = cl::sycl::atomic_fetch_min(a, static_cast<T>(1), order);
    old = cl::sycl::atomic_fetch_max(a, static_cast<T>(1), order);
  }
};
