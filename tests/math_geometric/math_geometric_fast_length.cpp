...
#define TEST_NAME math_geometric_fast_length
...
struct test_class
{
    ...
    void execute( util::logger & log, cl::sycl::queue & sycl_queue )
    {
        ...
        cl::sycl::buffer<vec_type_t, 1> buf_param_2( &m_param [0], cl::sycl::range<1>( buffer_size_k ) );
        ...
        sycl_queue.submit( [&]( cl::sycl::handler & cgh )
        {
            ...
            auto acc_param_2 = buf_param_2.template get_access<cl::sycl::access::mode::read_write, cl::sycl::access::target::global_buffer>( cgh );
...
} /* namespace math_geometric_fast_length__ */
