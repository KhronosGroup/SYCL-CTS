...
bool verify_vector( float & input,vec_type_t & param_x, vec_type_t & param_y )
{
...
template <typename vec_type_t>
bool verify_vector( double & input,vec_type_t & param_x, vec_type_t & param_y )
{
...
struct test_class
{
    ...
    test_buffer<vec_type_t, buffer_size_k> m_param_1;
    test_buffer<vec_type_t, buffer_size_k> m_param_2;
    ...
    void generate( )
    {
          ...
          {
              /* access buffers */
             vec_type_t & e_param1 = m_param_1[ i ];
             vec_type_t & e_param2 = m_param_2[ i ];
