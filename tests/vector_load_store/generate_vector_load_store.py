...
def gen_kernel_name(type_str, size):
    return 'KERNEL_load_store_' + remove_namespaces_whitspaces(type_str) + str(size)


def gen_load_store_test(type_str, size):
    no_whitespace_type_str = remove_namespaces_whitspaces(type_str)
