  ...
  void run(util::logger &log) override {
    ...
    // dim 1
    {
      ...
      if ((id_moved_constr[0] != sizes[0]) ||
        ...
        FAIL(log, "id with id was not move constructed correctly for dim = 1");
      }
    ...
    // dim 2
    {
      ...
      if ((id_moved_constr[0] != sizes[0]) ||
        ...
        FAIL(log, "id with id was not move constructed correctly for dim = 2");
      }
    ...
    // dim 3
    {
      ...
      if ((id_moved_constr[0] != sizes[0]) ||
        ...
        FAIL(log, "id with id was not move constructed correctly for dim = 3");
      }
