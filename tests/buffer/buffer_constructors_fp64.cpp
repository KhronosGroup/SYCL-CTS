...
public:
  ...
  void run(util::logger &log) override {
    ...
    for_type_and_vectors<buffer_constructors_common::check_buffer_ctors_for_type, double>(log, "double");
#ifdef SYCL_CTS_ENABLE_FULL_CONFORMANCE
    for_type_and_vectors<buffer_constructors_common::check_buffer_ctors_for_type, cl::sycl::cl_double>(
