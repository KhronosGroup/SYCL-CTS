...
TestConstants constants;
  ...
  check_api_call("parallel_for(nd_range, lambda) with custom nd_item", queue,
  ...
  check_api_call("parallel_for(nd_range, functor) with custom nd_item", queue,
                 [&](handler &cgh, accessor_t acc) {
                   cgh.parallel_for<class parallel_for_nd_range_custom_nd_item_functor_kernel>(
                       constants.ndRange, parallel_for_nd_range_custom_nd_item_functor(acc));
                 });
#if SYCL_CTS_ENABLE_FEATURE_SET_FULL
  check_api_call("parallel_for(nd_range, lambda) with custom nd_item, no kernel name", queue,
                 [&](handler &cgh, accessor_t acc) {
  ...
  check_api_call("parallel_for(nd_range, functor) with custom nd_item, no kernel name", queue,
                 [&](handler &cgh, accessor_t acc) {
  ...
  check_api_call(
      ...
      [&](handler &cgh, accessor_t acc) {
        cgh.parallel_for<class parallel_for_nd_range_offset_custom_nd_item_kernel>(
  ...
  check_api_call(
      ...
      [&](handler &cgh, accessor_t acc) {
        cgh.parallel_for<class parallel_for_nd_range_offset_custom_nd_item_functor_kernel>(
            constants.offsetNdRange, parallel_for_nd_range_custom_nd_item_functor(acc));
      },
      constants.offset[0], constants.offsetRange[0]);
#if SYCL_CTS_ENABLE_FEATURE_SET_FULL
  check_api_call(
      "parallel_for(nd_range, lambda) with custom nd_item and offset, no kernel name", queue,
      [&](handler &cgh, accessor_t acc) {
      ...
      constants.offset[0], constants.offsetRange[0]);
  check_api_call(
      "parallel_for(nd_range, functor) with custom nd_item and offset, no kernel name", queue,
      [&](handler &cgh, accessor_t acc) {
        cgh.parallel_for(constants.offsetNdRange, parallel_for_nd_range_custom_nd_item_functor(acc));
      },
      constants.offset[0], constants.offsetRange[0]);
