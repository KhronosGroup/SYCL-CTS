  ...
  void run(util::logger &log) override {
     ...
     */
    {
      ...
      if (!is_compiler_available(deviceList)) {
        ...
        ctsQueue.submit(
            [&](sycl::handler &cgh) { cgh.single_task(test_kernel<0>()); });
     ...
     */
    {
      ...
      if (!is_compiler_available(deviceList)) {
        ...
        ctsQueue.submit(
            [&](sycl::handler &cgh) { cgh.single_task(test_kernel<1>()); });
     ...
     */
    {
      ...
      if (!is_compiler_available(deviceList)) {
        ...
        ctsQueue.submit(
            [&](sycl::handler &cgh) { cgh.single_task(test_kernel<2>()); });
     ...
     */
    {
      ...
      if (!is_compiler_available(deviceList)) {
        ...
        ctsQueue.submit(
            [&](sycl::handler &cgh) { cgh.single_task(test_kernel<3>()); });
     ...
     */
    {
      ...
      if (!is_compiler_available(deviceList)) {
        ...
        ctsQueue.submit(
            [&](sycl::handler &cgh) { cgh.single_task(test_kernel<4>()); });
        ...
        ctsQueue.submit(
            [&](sycl::handler &cgh) { cgh.single_task(test_kernel<5>()); });
        kernelC = (kernelA);
        ...
        ctsQueue.submit(
            [&](sycl::handler &cgh) { cgh.single_task(test_kernel<6>()); });
     ...
     */
    {
      ...
      if (!is_compiler_available(deviceList)) {
        ...
        ctsQueue.submit(
            [&](sycl::handler &cgh) { cgh.single_task(test_kernel<7>()); });
