...
#define TEST_NAME has_kernel_bundle_core_atomic64_dev
...
class TEST_NAME : public sycl_cts::util::test_base {
 public:
  ...
  void run(util::logger &log) override {
    ...
    core<kernel_atomic64_descriptor, sycl::bundle_state::executable,
         overload::id::ctx_dev>{}(log, ctx, dev, "kernel_atomic64_descriptor");
    core<kernel_atomic64_descriptor, sycl::bundle_state::input,
         overload::id::ctx_dev>{}(log, ctx, dev, "kernel_atomic64_descriptor");
    core<kernel_atomic64_descriptor, sycl::bundle_state::object,
         overload::id::ctx_dev>{}(log, ctx, dev, "kernel_atomic64_descriptor");
  }
};
