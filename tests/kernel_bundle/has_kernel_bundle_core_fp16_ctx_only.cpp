...
//  kernels with sycl::requires(has(sycl::aspect::fp16)) requirement for device
...
#define TEST_NAME has_kernel_bundle_core_fp16_ctx_only
 ...
 public:
  ...
  void run(util::logger &log) override {
    ...
    core<kernel_fp16_descriptor, sycl::bundle_state::input,
         overload::id::ctx_only>{}(log, ctx, dev, "kernel_fp16_descriptor");
