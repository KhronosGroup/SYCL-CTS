...
//  kernels with sycl::requires(has(sycl::aspect::fp64)) requirement for device
...
#define TEST_NAME has_kernel_bundle_core_fp64_ctx_only
...
class TEST_NAME : public sycl_cts::util::test_base {
 public:
  ...
  void run(util::logger &log) override {
    ...
    core<kernel_fp64_descriptor, sycl::bundle_state::input,
         overload::id::ctx_only>{}(log, ctx, dev, "kernel_fp64_descriptor");
    core<kernel_fp64_descriptor, sycl::bundle_state::object,
         overload::id::ctx_only>{}(log, ctx, dev, "kernel_fp64_descriptor");
    core<kernel_fp64_descriptor, sycl::bundle_state::executable,
         overload::id::ctx_only>{}(log, ctx, dev, "kernel_fp64_descriptor");
  }
};
