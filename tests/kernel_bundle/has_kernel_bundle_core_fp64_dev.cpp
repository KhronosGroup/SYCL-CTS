...
//  for kernels with sycl::requires(has(sycl::aspect::fp64)) requirement for
...
#define TEST_NAME has_kernel_bundle_core_fp64_dev
 ...
 public:
  ...
  void run(util::logger &log) override {
    ...
    core<kernel_fp64_descriptor, sycl::bundle_state::input,
         overload::id::ctx_dev>{}(log, ctx, dev, "kernel_fp64_descriptor");
