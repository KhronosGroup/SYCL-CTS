...
//  kernel with sycl::reqd_work_group_size(1024) requirements for device
//  from chosen platform.
//
...
#define TEST_NAME \
  has_kernel_bundle_core_reqd_like_unsupport_work_group_size_ctx_only
...
class TEST_NAME : public sycl_cts::util::test_base {
 public:
  ...
  void run(util::logger &log) override {
    ...
    core<kernel_likely_unsupported_work_group_size_descriptor,
         sycl::bundle_state::input, overload::id::ctx_only>{}(
        log, ctx, dev, "kernel_likely_unsupported_work_group_size_descriptor");
    core<kernel_likely_unsupported_work_group_size_descriptor,
         sycl::bundle_state::object, overload::id::ctx_only>{}(
        log, ctx, dev, "kernel_likely_unsupported_work_group_size_descriptor");
    core<kernel_likely_unsupported_work_group_size_descriptor,
         sycl::bundle_state::executable, overload::id::ctx_only>{}(
        log, ctx, dev, "kernel_likely_unsupported_work_group_size_descriptor");
  }
};
