...
//  context, devices) with device that are not associated with provided context
//  (devices from different platforms).
//
...
#define TEST_NAME \
  has_kernel_bundle_throws_diff_dev_from_diff_platform_dev_and_k_name
 ...
 public:
  ...
  void run(util::logger &log) override {
    ...
    check::throws<simple_kernel_descriptor, sycl::bundle_state::input,
                  overload::id::ctx_dev_kname>{}(log, ctx,
