...
//  for kernel with sycl::reqd_sub_group_size(3) requirements for device from
//  chosen platform.
//
...
#define TEST_NAME has_kernel_bundle_core_like_unsupport_reqd_sub_group_size_dev
...
class TEST_NAME : public sycl_cts::util::test_base {
 public:
  ...
  void run(util::logger &log) override {
    ...
    core<kernel_likely_unsupported_sub_group_size_descriptor, sycl::bundle_state::input,
         overload::id::ctx_dev>{}(log, ctx, dev,
                                  "kernel_likely_unsupported_sub_group_size_descriptor");
    core<kernel_likely_unsupported_sub_group_size_descriptor, sycl::bundle_state::object,
         overload::id::ctx_dev>{}(log, ctx, dev,
                                  "kernel_likely_unsupported_sub_group_size_descriptor");
    core<kernel_likely_unsupported_sub_group_size_descriptor, sycl::bundle_state::executable,
         overload::id::ctx_dev>{}(log, ctx, dev,
                                  "kernel_likely_unsupported_sub_group_size_descriptor");
  }
};
