...
//  context) for kernel with sycl::aspect::online_compiler (if
//  bundle_state::input) and for sycl::aspect::linker (if bundle_state::object).
//
...
#define TEST_NAME has_kernel_bundle_core_all_states_k_name
 ...
 public:
  ...
  void run(util::logger &log) override {
    ...
    core<simple_kernel_descriptor, sycl::bundle_state::input,
         overload::id::ctx_kname>{}(log, ctx, dev, "simple_kernel_descriptor");
