...
//  kernel with sycl::reqd_work_group_size requirements for device without
//  context, devices) for such support.
//
...
#define TEST_NAME has_kernel_bundle_core_reqd_work_group_size_dev_and_k_name
