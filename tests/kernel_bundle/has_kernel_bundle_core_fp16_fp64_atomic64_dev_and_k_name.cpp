...
//  context, devices) for kernels with sycl::requires(has(sycl::aspect::fp16))/
//  fp64/atomic64 requirements for all available devices.
//
...
#define TEST_NAME has_kernel_bundle_core_fp16_fp64_atomic64_dev_and_k_name
