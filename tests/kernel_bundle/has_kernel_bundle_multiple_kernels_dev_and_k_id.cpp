...
//  sycl::has_kernel_bundle<sycl::bundle_state>(context, devices, kernelIds)
//  calling result.
//
*******************************************************************************/
...
#define TEST_NAME has_kernel_bundle_multiple_kernels_dev_and_k_id
...
using verifier = check::multiple_kernels<BundleState, overload::id::ctx_dev_kid>;
