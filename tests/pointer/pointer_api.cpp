...
public:
    void operator()( util::logger &log, cl::sycl::queue &queue )
    {
        ...
        {
            cl::sycl::accessor<cl::sycl::access::mode::read_write, cl::sycl::access::target::global_buffer> globalAccessor(
                buffer, handler );
            cl::sycl::accessor<cl::sycl::access::mode::read, cl::sycl::access::target::constant_buffer> constantAccessor(
                buffer, handler );
            cl::sycl::accessor<cl::sycl::access::mode::read_write, cl::sycl::access::target::local> constantAccessor(
                size, handler );
            ...
            handler.single_task( [=]()
            {
                ...
                */
                {
                    ...
                    cl::sycl::private_ptr<T> provatePtr( privateData );
                    cl::sycl::multi_ptr<T, cl::sycl::address_space::global_space> globalMultiPtr( &globalAccessor[0] );
                    cl::sycl::multi_ptr<T, cl::sycl::cl::sycl::address_space::constant_space> constantMultiPtr( &constantAccessor[0] );
                    cl::sycl::multi_ptr<T, cl::sycl::address_space::local_space>localMultiPtr( &localAccessor[0] );
                    cl::sycl::multi_ptr<T, cl::sycl::address_space::private_space> privateMultiPtr( privateData );
                ...
                */
                {
                    cl::sycl::multi_ptr<T, cl::sycl::address_space::global_space> globalMultiPtr = make_ptr<T, cl::sycl::address_space::global_space>(&globalAccessor[0]);
                    cl::sycl::multi_ptr<T, cl::sycl::address_space::constant_space> constantMultiPtr = make_ptr<T, cl::sycl::address_space::constant_space>(&constantAccessor[0]);
                    cl::sycl::multi_ptr<T, cl::sycl::address_space::local_space>localMultiPtr = make_ptr<T, cl::sycl::address_space::local_space>(&localAccessor[0]);
                    cl::sycl::multi_ptr<T, cl::sycl::address_space::private_space> privateMultiPtr = make_ptr<T, cl::sycl::address_space::private_space>(privateData);
                }
