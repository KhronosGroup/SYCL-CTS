    ...
    virtual void run( util::logger &log )
    {
        try
        {
...

            {
                ...
                {
                    auto acc_o = buf_o. template get_access <cl::sycl::access::mode::write> ( cgh );
                    auto acc_x = buf_x. template get_access <cl::sycl::access::mode::read > ( cgh );
                    auto acc_y = buf_y. template get_access <cl::sycl::access::mode::read > ( cgh );
