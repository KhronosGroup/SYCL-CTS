 ...
 public:
  ...
  void test_equality(util::logger& log) {
    try {
      ...
      // group is not default constructible, store two objects
      ...
      // First store two instances of group into the array
      {
        ...
        // Retrieve two group objects and store them
        ...
        testQueue.submit([&](cl::sycl::handler& cgh) {
          ...
          cgh.single_task<group_equality_kernel<numDims>>([=]() {
