...
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(char, 4), char>>
    proxy2;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(uchar, 4), uchar>>
    proxy3;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(short, 4), short>>
    proxy4;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(ushort, 4), ushort>>
    proxy5;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(int, 4), int>> proxy6;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(uint, 4), uint>>
    proxy7;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(float, 4), float>>
    proxy8;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(double, 4), double>>
    proxy9;
