...
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(char,  3),int8_t>>  proxy2;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(uchar, 3),uint8_t>>  proxy3;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(short, 3),int16_t>>  proxy4;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(ushort,3),uint16_t>>  proxy5;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(int,   3),int32_t>>  proxy6;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(uint,  3),uint32_t>>  proxy7;
