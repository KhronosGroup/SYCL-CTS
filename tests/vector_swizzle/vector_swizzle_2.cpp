...
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(char,  2),int8_t>>  proxy2;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(uchar, 2),uint8_t>>  proxy3;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(short, 2),int16_t>>  proxy4;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(ushort,2),uint16_t>>  proxy5;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(int,   2),int32_t>>  proxy6;
util::test_proxy<TEST_NAME<CREATE_VECTOR_TYPE(uint,  2),uint32_t>>  proxy7;
