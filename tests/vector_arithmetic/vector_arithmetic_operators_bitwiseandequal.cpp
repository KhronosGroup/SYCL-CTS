...
#define TEST_NAME vector_arithmetic_operators_bitwiseandequal
#define KERNEL_NAME cKernel_vector_arithmetic_operators_bitwiseandequal
#define ARITHMETIC_OPERATOR &=
#define COMPOUND_OPERATION 1
#define NAMESPACE vector_arithmetic_operators_bitwiseandequal__
