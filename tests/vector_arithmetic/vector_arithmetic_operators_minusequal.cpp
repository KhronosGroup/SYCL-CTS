...
#define TEST_NAME vector_arithmetic_operators_minusequal
#define KERNEL_NAME cKernel_vector_arithmetic_operators_minusequal
#define ARITHMETIC_OPERATOR -=
#define COMPOUND_OPERATION 1
#define NAMESPACE vector_arithmetic_operators_minusequal__
