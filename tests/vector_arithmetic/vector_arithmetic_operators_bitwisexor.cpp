...
#define TEST_NAME vector_arithmetic_operators_bitwisexor
#define KERNEL_NAME cKernel_vector_arithmetic_operators_bitwisexor
#define ARITHMETIC_OPERATOR ^
#define COMPOUND_OPERATION 0
#define NAMESPACE vector_arithmetic_operators_bitwisexor__
