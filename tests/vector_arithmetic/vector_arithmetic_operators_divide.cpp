...
#define TEST_NAME vector_arithmetic_operators_divide
#define KERNEL_NAME cKernel_vector_arithmetic_operators_divide
#define ARITHMETIC_OPERATOR /
#define COMPOUND_OPERATION 0
#define NAMESPACE vector_arithmetic_operators_divide__
