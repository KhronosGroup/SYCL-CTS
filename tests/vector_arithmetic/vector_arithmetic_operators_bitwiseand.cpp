...
#define TEST_NAME vector_arithmetic_operators_bitwiseand
#define KERNEL_NAME cKernel_vector_arithmetic_operators_bitwiseand
#define ARITHMETIC_OPERATOR &
#define COMPOUND_OPERATION 0
#define NAMESPACE vector_arithmetic_operators_bitwiseand__
