...
#define TEST_NAME vector_arithmetic_operators_bitwiseorequal
#define KERNEL_NAME cKernel_vector_arithmetic_operators_bitwiseorequal
#define ARITHMETIC_OPERATOR |=
#define COMPOUND_OPERATION 1
#define NAMESPACE vector_arithmetic_operators_bitwiseorequal__
