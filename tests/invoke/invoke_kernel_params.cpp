...
{
private:
    typedef cl::sycl::accessor<uint32_t, 1, cl::sycl::access::mode::write, cl::sycl::access::target::global_buffer> acc_uint32_t;
            ...
            try
            {
                ...
                my_queue.submit(
                    [&]( cl::sycl::handler& cgh )
                    {
                        ...
                        // access the output
                        auto acc_pass =
                            buf_result.template get_access<cl::sycl::access::mode::write, cl::sycl::access::target::global_buffer>( cgh );
