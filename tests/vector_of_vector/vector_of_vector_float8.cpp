...
#define TEST_NAME vector_of_vector_float8
...
public:
    ...
    void operator()(item<1> item)
    {
        float1  v1  (V1S0);
    	float2  v2  (V2S0,  V2S1);
		float3  v3  (V3S0,  V3S1,  V3S2);
		float4  v4  (V4S0,  V4S1,  V4S2,  V4S3);
		float8  v8  (V8S0,  V8S1,  V8S2,  V8S3,  V8S4,  V8S5,  V8S6,  V8S7);
		float16 v16 (V16S0, V16S1, V16S2, V16S3, V16S4, V16S5, V16S6, V16S7, V16S8, V16S9, V16S10, V16S11, V16S12, V16S13, V16S14, V16S15);
...
util::test_proxy<TEST_NAME<float8>>  proxy4;
