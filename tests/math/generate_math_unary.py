...
# global variables
#
g_template_file_name     = "math_unary"
g_function_name_ulp_map  = [{"$TEST_FUNC$" : "acos",     "$MAX_ULPS$" : "4.0f"},
...
/*************************************************************************
//
//  This file was AUTOMATICALLY GENERATED from math_unary.template
//
**************************************************************************/
"""
...
def main( ):
    ...
    template_file_name = g_template_file_name + ".template"
    template_file = os.path.join(pathname, template_file_name)
    # open file
    with open(template_file, "r") as f:
        template_content = f.read()

    for item in g_function_name_ulp_map:
        ...
        generated_file_name = g_template_file_name + "_" + item['$TEST_FUNC$'] + ".cpp"
