...
//
//  Provides tests for generic sycl::accessor placeholder buufer range offset
//  constructor
//
*******************************************************************************/
#ifndef SYCL_CTS_GENERIC_ACCESSOR_PLACEHOLDER_BUFFER_RANFE_OFFSET_CONSTRUCTORS_H
#define SYCL_CTS_GENERIC_ACCESSOR_PLACEHOLDER_BUFFER_RANFE_OFFSET_CONSTRUCTORS_H
#include "accessor_common.h"

#include "catch2/catch_test_macros.hpp"

namespace generic_accessor_placeholder_buffer_range_offset_constructor {
...
template <typename DataT, int Dimension, sycl::access_mode AccessMode,
          sycl::target Target>
void test_placeholder_buffer_range_offset_constructor(
...
class run_tests_placeholder_buffer_range_offset_constructor {
 ...
 public:
  void operator()(const std::string& type_name,
                  ...
                  const std::string& target_name) {
    test_placeholder_buffer_range_offset_constructor<T, Dimension, AccessMode,
                                                     Target>(
        type_name, access_mode_name, target_name);
  }
};
...
class run_generic_placeholder_buffer_range_offset_constructor_test {
 public:
  void operator()(const std::string& type_name) {
    ...
    for_all_combinations<run_tests_placeholder_buffer_range_offset_constructor,
...
#endif  // SYCL_CTS_GENERIC_ACCESSOR_PLACEHOLDER_BUFFER_RANFE_OFFSET_CONSTRUCTORS_H
