...
//
//  Provides tests for generic sycl::accessor placeholder buffer constructor
//  exceptions
//
*******************************************************************************/
#ifndef SYCL_CTS_GENERIC_ACCESSOR_PLACEHOLDER_BUFFER_CONSTRUCTOR_EXCEPTIONS_H
#define SYCL_CTS_GENERIC_ACCESSOR_PLACEHOLDER_BUFFER_CONSTRUCTOR_EXCEPTIONS_H
#include "accessor_common.h"

#include "catch2/catch_test_macros.hpp"

namespace generic_accessor_placeholder_buffer_constructor_exceptions {
...
class run_tests_placeholder_buffer_constructor_exceptions {
 ...
 public:
  void operator()(const std::string& type_name,
                  ...
                  const std::string& target_name) {
    test_placeholder_buffer_accessors_exception<T, Dimension, AccessMode,
                                                Target>(
...
template <typename T>
class run_generic_placeholder_buffer_constructor_exceptions_test {
 public:
  void operator()(const std::string& type_name) {
    ...
    for_all_combinations<run_tests_placeholder_buffer_constructor_exceptions,
...
#endif  // SYCL_CTS_GENERIC_ACCESSOR_PLACEHOLDER_BUFFER_CONSTRUCTOR_EXCEPTIONS_H
