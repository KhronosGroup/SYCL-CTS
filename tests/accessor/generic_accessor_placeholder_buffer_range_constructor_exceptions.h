...
//
*******************************************************************************/
#ifndef SYCL_CTS_GENERIC_ACCESSOR_PLACEHOLDER_BUFFER_RANGE_CONSTRUCTOR_EXCEPTIONS_H
#define SYCL_CTS_GENERIC_ACCESSOR_PLACEHOLDER_BUFFER_RANGE_CONSTRUCTOR_EXCEPTIONS_H
#include "accessor_common.h"

#include "catch2/catch_test_macros.hpp"

namespace generic_accessor_placeholder_buffer_range_constructor_exceptions {
...
template <typename DataT, int Dimension, sycl::access_mode AccessMode,
          sycl::target Target>
void test_placeholder_buffer_range_accessors_exception(
...
class run_tests_placeholder_buffer_range_constructor_exceptions {
 ...
 public:
  void operator()(const std::string& type_name,
                  ...
                  const std::string& target_name) {
    test_placeholder_buffer_range_accessors_exception<T, Dimension, AccessMode,
                                                      Target>(
        type_name, access_mode_name, target_name);
  }
};
...
template <typename T>
class run_generic_placeholder_buffer_range_constructor_exceptions_test {
 public:
  void operator()(const std::string& type_name) {
    ...
    for_all_combinations<
        run_tests_placeholder_buffer_range_constructor_exceptions, T>(
    ...
    const auto read_only_acc_mode =
        value_pack<sycl::access_mode, sycl::access_mode::read>::generate_named(
            "access_mode::read");
    for_all_combinations<
        run_tests_placeholder_buffer_range_constructor_exceptions, const T>(
        read_only_acc_mode, targets, dimensions, actual_type_name);
  }
};
}  // namespace generic_accessor_placeholder_buffer_range_constructor_exceptions
#endif  // SYCL_CTS_GENERIC_ACCESSOR_PLACEHOLDER_BUFFER_RANGE_CONSTRUCTOR_EXCEPTIONS_H
