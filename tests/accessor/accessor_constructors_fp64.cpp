 ...
 */
class dummy_accessor_constructors_buffer_fp64 {};
using dummy_functor = ::dummy_functor<dummy_accessor_constructors_buffer_fp64>;

template <typename T, size_t dims>
class buffer_accessor_dims_fp64 {
 public:
  static void check(util::logger &log, cl::sycl::queue &queue) {
    int size = 32;

    /** check buffer fp64 accessor constructors for n > 0 dimensions
     */
    ...
    /** check buffer fp64 accessor constructors for global_buffer
     */
    {
      queue.submit([&](cl::sycl::handler &h) {
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 accessor for read is not constructed "
                 "correctly "
                 "(get_size)");
          }
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer ranged fp64 accessor for read is not "
                 "constructed "
                 "correctly (get_size)");
          }
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 accessor for write is not constructed "
                 "correctly "
                 "(get_size)");
          }
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer ranged fp64 accessor for write is not "
                 "constructed "
                 "correctly (get_size)");
          }
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(
                log,
                "global_buffer fp64 accessor for read_write is not constructed "
                "correctly (get_size)");
          }
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer ranged fp64 accessor for read_write is not "
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 accessor for discard_write is not "
                 "constructed "
                 "correctly (get_size)");
          }
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer ranged fp64 accessor for discard_write is not "
                 "constructed correctly (get_size)");
          }
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 accessor for discard_read_write is not "
                 "constructed correctly (get_size)");
          }
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer ranged fp64 accessor for discard_read_write is "
                 "not "
                 "constructed correctly (get_size)");
          }
        ...
        /** check (buffer, handler) global_buffer fp64 accessor constructors for
         *  atomic
         */

        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 accessor for atomic is not constructed "
                 "correctly (get_size)");
          }
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer ranged fp64 accessor for atomic is not "
                 "constructed "
                 "correctly (get_size)");
          }
        ...
        /** check fp64 accessor is Copy Constructible
         */
        {
          cl::sycl::accessor<T, dims, cl::sycl::access::mode::read,
                             cl::sycl::access::target::global_buffer,
          ...
          if (a.get_size() != b.get_size()) {
            FAIL(log,
                 "global_buffer fp64 accessor is not copy constructible "
                 "(get_size)");
          }
        ...
        /** check fp64 accessor is Copy Assignable
         */
        {
          cl::sycl::accessor<T, dims, cl::sycl::access::mode::read,
                             cl::sycl::access::target::global_buffer,
          ...
          if (a.get_size() != b.get_size()) {
            FAIL(log,
                 "global_buffer fp64 accessor is not copy assignable "
                 "(get_size)");
          }
        ...
        /** check fp64 accessor is Move Constructible
         */
        {
          cl::sycl::accessor<T, dims, cl::sycl::access::mode::read,
                             cl::sycl::access::target::global_buffer,
          ...
          if (b.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 accessor is not move constructible "
                 "(get_size)");
          }
        ...
        /** check fp64 accessor is Move Assignable
         */
        {
          cl::sycl::accessor<T, dims, cl::sycl::access::mode::read,
                             cl::sycl::access::target::global_buffer,
          ...
          if (b.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 accessor is not move assignable "
                 "(get_size)");
          }
    ...
    /** check buffer fp64 accessor constructors for constant_buffer
     */
    {
      queue.submit([&](cl::sycl::handler &h) {
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "constant_buffer fp64 accessor for read is not constructed "
                 "correctly (get_size)");
          }
         ...
         */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "constant_buffer ranged fp64 accessor for read is not "
                 "constructed "
                 "correctly (get_size)");
          }
         ...
         */
        {
          ...
          if (a.get_size() != b.get_size()) {
            FAIL(log,
                 "constant_buffer fp64 accessor is not copy constructible "
                 "(get_size)");
          }
         ...
         */
        {
          ...
          if (a.get_size() != b.get_size()) {
            FAIL(log,
                 "constant_buffer fp64 accessor is not copy assignable "
                 "(get_size)");
          }
         ...
         */
        {
          ...
          if (b.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "constant_buffer fp64 accessor is not move constructible "
                 "(get_size)");
          }
         ...
         */
        {
          ...
          if (b.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "constant_buffer fp64 accessor is not move assignable "
                 "(get_size)");
          }
    ...
    /** check buffer fp64 accessor constructors for host_buffer
     */
    {
       ...
       */
      {
        ...
        if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
          FAIL(
              log,
              "host_buffer fp64 accessor for read is not constructed correctly "
              "(get_size)");
        }
       ...
       */
      {
        ...
        if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
          FAIL(log,
               "host_buffer ranged fp64 accessor for read is not constructed "
               "correctly (get_size)");
        }
       ...
       */
      {
        ...
        if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
          FAIL(log,
               "host_buffer fp64 accessor for write is not constructed "
               "correctly "
               "(get_size)");
        }
       ...
       */
      {
        ...
        if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
          FAIL(log,
               "host_buffer ranged fp64 accessor for write is not constructed "
               "correctly (get_size)");
        }
       ...
       */
      {
        ...
        if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
          FAIL(log,
               "host_buffer fp64 accessor for read_write is not constructed "
               "correctly (get_size)");
        }
       ...
       */
      {
        ...
        if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
          FAIL(log,
               "host_buffer ranged fp64 accessor for read_write is not "
               "constructed "
               "correctly (get_size)");
        }
       ...
       */
      {
        ...
        if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
          FAIL(log,
               "host_buffer fp64 accessor for discard_write is not constructed "
               "correctly (get_size)");
        }
        ...
        if (a.is_placeholder() != false) {
          FAIL(log,
               "host_buffer fp64 accessor fordiscard_write is not constructed "
               "correctly (is_placeholder)");
        }
      }
       ...
       */
      {
        ...
        if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
          FAIL(log,
               "host_buffer ranged fp64 accessor for discard_write is not "
               "constructed correctly (get_size)");
        }
       ...
       */
      {
        ...
        if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
          FAIL(log,
               "host_buffer fp64 accessor for discard_read_write is not "
               "constructed "
               "correctly (get_size)");
        }
       ...
       */
      {
        ...
        if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
          FAIL(log,
               "host_buffer ranged fp64 accessor for discard_read_write is not "
               "constructed correctly (get_size)");
        }
       ...
       */
      {
        ...
        if (a.get_size() != b.get_size()) {
          FAIL(
              log,
              "host_buffer fp64 accessor is not copy constructible (get_size)");
        }

        if (a.get_count() != b.get_count()) {
          FAIL(log,
               "host_buffer fp64 accessor is not copy constructible "
               "(get_count)");
        }
       ...
       */
      {
        ...
        if (a.get_size() != b.get_size()) {
          FAIL(log,
               "host_buffer fp64 accessor is not copy assignable (get_size)");
        }

        if (a.get_count() != b.get_count()) {
          FAIL(log,
               "host_buffer fp64 accessor is not copy assignable (get_count)");
        }

        if (a.get_offset() != b.get_offset()) {
          FAIL(log,
               "host_buffer fp64 accessor is not copy assignable (get_offset)");
        }

        if (a.get_range() != b.get_range()) {
          FAIL(log,
               "host_buffer fp64 accessor is not copy assignable (get_range)");
        }

        if (a.is_placeholder() != b.is_placeholder()) {
          FAIL(log,
               "host_buffer fp64 accessor is not copy assignable "
               "(is_placeholder)");
        }
      }
       ...
       */
      {
        ...
        if (b.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
          FAIL(
              log,
              "host_buffer fp64 accessor is not move constructible (get_size)");
        }

        if (b.get_count() != getElementsCount<dims>(range)) {
          FAIL(log,
               "host_buffer fp64 accessor is not move constructible "
               "(get_count)");
        }
       ...
       */
      {
        ...
        if (b.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
          FAIL(log,
               "host_buffer fp64 accessor is not move assignable (get_size)");
        }

        if (b.get_count() != getElementsCount<dims>(range)) {
          FAIL(log,
               "host_buffer fp64 accessor is not move assignable (get_count)");
        }

        if (b.get_offset() != offset) {
          FAIL(log,
               "host_buffer fp64 accessor is not move assignable (get_offset)");
        }

        if (b.get_range() != range) {
          FAIL(log,
               "host_buffer fp64 accessor is not move assignable (get_range)");
        }

        if (b.is_placeholder() != false) {
          FAIL(log,
               "host_buffer fp64 accessor is not move assignable "
               "(is_placeholder)");
        }
      }
    }
...
template <typename T>
class buffer_accessor_dims_fp64<T, 0> {
 public:
  static void check(util::logger &log, cl::sycl::queue &queue) {
     ...
     */
    {
       ...
       */
      {
        ...
        if (a.get_size() != b.get_size()) {
          FAIL(log,
               "global_buffer fp64 accessor is not copy assignable (get_size)");
        }

        if (a.get_count() != b.get_count()) {
          FAIL(
              log,
              "global_buffer fp64 accessor is not copy assignable (get_count)");
        }
...
template <typename T, size_t dims>
class placeholder_accessor_dims_fp64 {
 public:
  static void check(util::logger &log, cl::sycl::queue &queue) {
    int size = 32;
      ...
      queue.submit([&](cl::sycl::handler &h) {
        ...
        */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 placeholder accessor for read is not "
                 "constructed correctly (get_size)");
          }
        ...
        */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 placeholder accessor for write is not "
                 "constructed correctly (get_size)");
          }
        ...
        */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(
                log,
                "global_buffer fp64 placeholder accessor for read_write is not "
                "constructed correctly (get_size)");
          }
        ...
        */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 placeholder accessor for discard_write is "
                 "not "
                 "constructed correctly (get_size)");
          }
        ...
        */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 placeholder accessor for "
                 "discard_read_write is "
                 "not constructed correctly (get_size)");
          }
        ...
        */

        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 placeholder accessor for atomic is not "
                 "constructed correctly (get_size)");
          }
        ...
        */
        {
          ...
          if (a.get_size() != b.get_size()) {
            FAIL(log,
                 "global_buffer fp64 placeholder accessor is not copy "
                 "constructible "
                 "(get_size)");
          }
        ...
        */
        {
          ...
          if (b.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "global_buffer fp64 placeholder accessor is not move "
                 "constructible "
                 "(get_size)");
          }
        ...
        */
        {
          ...
          if (a.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "constant_buffer fp64 placeholder accessor for read is not "
                 "constructed correctly (get_size)");
          }
        ...
        */
        {
          ...
          if (a.get_size() != b.get_size()) {
            FAIL(log,
                 "constant_buffer fp64 placeholder accessor is not copy "
        ...
        */
        {
          ...
          if (b.get_size() != getElementsCount<dims>(range) * sizeof(T)) {
            FAIL(log,
                 "constant_buffer fp64 placeholder accessor is not move "
                 "constructible (get_size)");
          }
...
template <typename T>
class placeholder_accessor_dims_fp64<T, 0> {
 public:
  static void check(util::logger &log, cl::sycl::queue &queue) {
    cl::sycl::range<1> range = getRange<1>(1);
    std::vector<uint8_t> data(sizeof(T), 0);
 ...
 public:
  ...
  void run(util::logger &log) override {
    try {
      ...
      buffer_accessor_dims_fp64<double, 1>::check(log, queue);
      buffer_accessor_dims_fp64<double, 2>::check(log, queue);
      buffer_accessor_dims_fp64<double, 3>::check(log, queue);

      placeholder_accessor_dims_fp64<double, 0>::check(log, queue);
