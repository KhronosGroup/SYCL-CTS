...
//
//  Provides tests for generic sycl::accessor placeholder constructors
//
*******************************************************************************/
#ifndef SYCL_CTS_GENERIC_ACCESSOR_PLACEHOLDER_CONSTRUCTORS_H
#define SYCL_CTS_GENERIC_ACCESSOR_PLACEHOLDER_CONSTRUCTORS_H
#include "accessor_common.h"

#include "catch2/catch_test_macros.hpp"

namespace generic_accessor_placeholder_constructors {
...
class run_tests_placeholder_constructors {
...
template <typename T>
class run_generic_placeholder_constructors_test {
 public:
  void operator()(const std::string& type_name) {
    ...
    for_all_combinations<run_tests_placeholder_constructors, T>(
    ...
    const auto read_only_acc_mode =
        value_pack<sycl::access_mode, sycl::access_mode::read>::generate_named(
            "access_mode::read");
    for_all_combinations<run_tests_placeholder_constructors, const T>(
        read_only_acc_mode, targets, dimensions, actual_type_name);
  }
};
}  // namespace generic_accessor_placeholder_constructors
#endif  // SYCL_CTS_GENERIC_ACCESSOR_PLACEHOLDER_CONSTRUCTORS_H
