...
#define TEST_NAME specialization_constants_exceptions_catching_fp64

namespace TEST_NAMESPACE {
using namespace sycl_cts;

/** test specialization constants expected exceptions catching for double
 */
 ...
 public:
  ...
  void run(util::logger &log) override {
    try {
      ...
      check_spec_constant_except_catch_for_type<double> fp64_test{};
