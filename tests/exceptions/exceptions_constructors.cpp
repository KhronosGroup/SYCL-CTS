 ...
 * This overload will be expect that .has_context() return false and will try to
 * catch exception after calling get_context().
 *
 * @param e The exception instance that needs to be verified
 * @param errcode Expected error code from .code() member function
 * @param errcat Expected error category from .category() member function
 */
 ...
 * @param errcode Expected error code from .code() member function
 * @param errcat Expected error category from .category() member function
 * @param what_arg Expected string from .what() member function
 */
inline void check_exception(sycl::exception e, const std::error_code errcode,
                            const std::error_category& errcat,
...
/**
 * @brief The function helps to verify that exception was constructed correctly.
 * This overload will be expect that .has_context() return true.
 *
 * @param e The exception instance that needs to be verified
 * @param errcode Expected error code from .code() member function
 * @param errcat Expected error category from .category() member function
 * @param ctx Expected context from .get_context() member function
 */
inline void check_exception(sycl::exception e, const std::error_code errcode,
                            const std::error_category& errcat,
