...
class TEST_NAME : public util::test_base {
 public:
  ...
  void run(util::logger &log) override {
    ...
    check_enum_class_value(sycl::info::device::preferred_vector_width_char);
    check_enum_class_value(sycl::info::device::preferred_vector_width_short);
    check_enum_class_value(sycl::info::device::preferred_vector_width_int);
    check_enum_class_value(sycl::info::device::preferred_vector_width_long);
    check_enum_class_value(sycl::info::device::preferred_vector_width_float);
    check_enum_class_value(sycl::info::device::preferred_vector_width_double);
    check_enum_class_value(sycl::info::device::preferred_vector_width_half);
    ...
    check_enum_class_value(sycl::info::device::native_vector_width_double);
    ...
    check_enum_class_value(sycl::info::device::global_mem_cache_line_size);
    ...
    check_enum_class_value(sycl::info::device::profiling_timer_resolution);
    ...
    check_enum_class_value(sycl::info::device::preferred_interop_user_sync);
    ...
    check_enum_class_value(sycl::info::device::partition_affinity_domains);
    check_enum_class_value(sycl::info::device::partition_type_property);
    check_enum_class_value(sycl::info::device::partition_type_affinity_domain);
     ...
     */
    {
      ...
      check_get_info_param<sycl::info::device, sycl::info::device_type,
                           sycl::info::device::device_type>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::vendor_id>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::max_compute_units>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::max_work_item_dimensions>(log,
                                                                         dev);
      check_get_info_param<sycl::info::device, sycl::id<3>,
                           sycl::info::device::max_work_item_sizes>(log, dev);
      check_get_info_param<sycl::info::device, size_t,
                           sycl::info::device::max_work_group_size>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
      ...
      check_get_info_param<sycl::info::device, sycl::cl_uint,
          ...
          log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::preferred_vector_width_int>(log,
                                                                           dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
      ...
      check_get_info_param<sycl::info::device, sycl::cl_uint,
          ...
          log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::native_vector_width_char>(log,
                                                                         dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::native_vector_width_short>(log,
                                                                          dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::native_vector_width_int>(log,
                                                                        dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::native_vector_width_long>(log,
                                                                         dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::native_vector_width_float>(log,
                                                                          dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::native_vector_width_double>(log,
                                                                           dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::native_vector_width_half>(log,
                                                                         dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::max_clock_frequency>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::address_bits>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_ulong,
                           sycl::info::device::max_mem_alloc_size>(log, dev);
      check_get_info_param<sycl::info::device, bool,
                           sycl::info::device::image_support>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::max_read_image_args>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::max_write_image_args>(log, dev);
      check_get_info_param<sycl::info::device, size_t,
                           sycl::info::device::image2d_max_height>(log, dev);
      check_get_info_param<sycl::info::device, size_t,
                           sycl::info::device::image2d_max_width>(log, dev);
      check_get_info_param<sycl::info::device, size_t,
                           sycl::info::device::image3d_max_height>(log, dev);
      check_get_info_param<sycl::info::device, size_t,
                           sycl::info::device::image3d_max_width>(log, dev);
      check_get_info_param<sycl::info::device, size_t,
                           sycl::info::device::image3d_max_depth>(log, dev);
      check_get_info_param<sycl::info::device, size_t,
                           sycl::info::device::image_max_buffer_size>(log, dev);
      check_get_info_param<sycl::info::device, size_t,
                           sycl::info::device::image_max_array_size>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::max_samplers>(log, dev);
      check_get_info_param<sycl::info::device, size_t,
                           sycl::info::device::max_parameter_size>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::mem_base_addr_align>(log, dev);
      check_get_info_param<sycl::info::device,
                           std::vector<sycl::info::fp_config>,
                           sycl::info::device::half_fp_config>(log, dev);
      check_get_info_param<sycl::info::device,
                           std::vector<sycl::info::fp_config>,
                           sycl::info::device::single_fp_config>(log, dev);
      check_get_info_param<sycl::info::device,
                           std::vector<sycl::info::fp_config>,
                           sycl::info::device::double_fp_config>(log, dev);
      check_get_info_param<sycl::info::device,
                           sycl::info::global_mem_cache_type,
                           sycl::info::device::global_mem_cache_type>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::global_mem_cache_line_size>(log,
                                                                           dev);
      check_get_info_param<sycl::info::device, sycl::cl_ulong,
                           sycl::info::device::global_mem_cache_size>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_ulong,
                           sycl::info::device::global_mem_size>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_ulong,
                           sycl::info::device::max_constant_buffer_size>(log,
                                                                         dev);
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::max_constant_args>(log, dev);
      check_get_info_param<sycl::info::device, sycl::info::local_mem_type,
                           sycl::info::device::local_mem_type>(log, dev);
      check_get_info_param<sycl::info::device, sycl::cl_ulong,
                           sycl::info::device::local_mem_size>(log, dev);
      check_get_info_param<sycl::info::device, bool,
                           sycl::info::device::error_correction_support>(log,
                                                                         dev);
      check_get_info_param<sycl::info::device, bool,
                           sycl::info::device::host_unified_memory>(log, dev);
      check_get_info_param<sycl::info::device, size_t,
                           sycl::info::device::profiling_timer_resolution>(log,
                                                                           dev);
      check_get_info_param<sycl::info::device, bool,
                           sycl::info::device::is_endian_little>(log, dev);
      check_get_info_param<sycl::info::device, bool,
                           sycl::info::device::is_available>(log, dev);
      check_get_info_param<sycl::info::device, bool,
                           sycl::info::device::is_compiler_available>(log, dev);
      check_get_info_param<sycl::info::device, bool,
                           sycl::info::device::is_linker_available>(log, dev);
      check_get_info_param<sycl::info::device,
                           std::vector<sycl::info::execution_capability>,
                           sycl::info::device::execution_capabilities>(log,
                                                                       dev);
      check_get_info_param<sycl::info::device, bool,
                           sycl::info::device::queue_profiling>(log, dev);
      check_get_info_param<sycl::info::device, std::vector<std::string>,
                           sycl::info::device::built_in_kernels>(log, dev);
      ...
      check_get_info_param<sycl::info::device, std::string,
                           sycl::info::device::opencl_c_version>(log, dev);
      check_get_info_param<sycl::info::device, std::vector<std::string>,
                           sycl::info::device::extensions>(log, dev);
      check_get_info_param<sycl::info::device, size_t,
                           sycl::info::device::printf_buffer_size>(log, dev);
      check_get_info_param<sycl::info::device, bool,
      ...
      check_get_info_param<sycl::info::device, sycl::cl_uint,
                           sycl::info::device::partition_max_sub_devices>(log,
                                                                          dev);
      check_get_info_param<sycl::info::device,
      ...
      check_get_info_param<sycl::info::device,
                           ...
                           sycl::info::device::partition_affinity_domains>(log,
                                                                           dev);
      check_get_info_param<sycl::info::device, sycl::info::partition_property,
                           sycl::info::device::partition_type_property>(log,
                                                                        dev);
      check_get_info_param<sycl::info::device,
