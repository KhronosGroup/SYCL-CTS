...
#define TEST_NAME math_relational_unary_signbit
#define TEST_TYPE signbit
#define KERNEL_NAME cKernel_signbit

namespace math_relational_unary_signbit__ {
...
} /* namespace math_relational_unary_signbit_$NUM_ELMS$__ */
