...
#define TEST_NAME math_relational_unary_isnormal
#define TEST_TYPE isnormal
#define KERNEL_NAME cKernel_isnormal

namespace math_relational_unary_isnormal__ {
...
} /* namespace math_relational_unary_isnormal_$NUM_ELMS$__ */
