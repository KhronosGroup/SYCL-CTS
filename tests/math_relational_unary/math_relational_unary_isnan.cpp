...
#define TEST_NAME math_relational_unary_isnan
#define TEST_TYPE isnan
#define KERNEL_NAME cKernel_isnan

namespace math_relational_unary_isnan__ {
...
} /* namespace math_relational_unary_isnan_$NUM_ELMS$__ */
