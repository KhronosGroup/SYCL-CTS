 ...
 public:
  ...
  virtual void run(util::logger &log) override {
    try {
      ...
      {
        cl::sycl::handler_event handlerEvent =
        ...
        */
        ...
        if (typeid(kernelEvent) != typeid(cl::sycl::event)) {
          FAIL(log,
               "cl::sycl::handler_event::get_kernel() does not return "
               "cl::sycl::event");
        }
        ...
        */
        ...
        if (typeid(completeEvent) != typeid(cl::sycl::event)) {
          FAIL(log,
               "cl::sycl::handler_event::get_complete() does not return "
               "cl::sycl::event");
        }
        ...
        */
        ...
        if (typeid(endEvent) != typeid(cl::sycl::event)) {
          FAIL(log,
               "cl::sycl::handler_event::get_end() does not return "
               "cl::sycl::event");
        }
      }
