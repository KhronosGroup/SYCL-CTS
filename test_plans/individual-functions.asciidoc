...
* Reference implementation of `template <typename T, int N, typename R = typename std::make_unsigned<T>::type>
...
typename std::make_unsigned<T>::type` instead following Table 178 definition. Implementation should be updated
