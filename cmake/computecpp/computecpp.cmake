# ComputeCpp options
option(COMPUTECPP_INSTALL_DIR "Path to the root of the ComputeCpp build directory.")

# Handling of options
if (COMPUTECPP_INSTALL_DIR)
    set(path_computeCppInstallDir ${COMPUTECPP_INSTALL_DIR})
    message(STATUS "Option COMPUTECPP_INSTALL_DIR set to ${COMPUTECPP_INSTALL_DIR}")
elseif()
    message(STATUS "Option COMPUTECPP_INSTALL_DIR has not been set.")
endif()

# Local variables
set(path_computeCppIncludeDir ${path_computeCppInstallDir}/include)
if (WIN32)
    set(filepath_computeCppCompiler ${path_computeCppInstallDir}/bin/compute++.exe)
    set(filepath_computeCppLibrary ${path_computeCppInstallDir}/lib/ComputeCpp_vs2015.lib)
else()
    set(filepath_computeCppCompiler ${path_computeCppInstallDir}/bin/compute++)
    set(filepath_computeCppLibrary ${path_computeCppInstallDir}/lib/libComputeCpp.so)
endif()
...
#    set(RUNTIME_COMPILER_FLAGS " ")
    set(DEVICE_COMPILER_FLAGS ${DEVICE_COMPILER_FLAGS} "-D_SIZE_T_DEFINED -D_NO_CRT_STDIO_INLINE")
...
# ------------------
include_directories(SYSTEM ${path_computeCppIncludeDir})
...
set_target_properties(${SYCL_LIB_NAME} PROPERTIES IMPORTED_LOCATION ${filepath_computeCppLibrary})
message(STATUS "ComputeCpp Library='${filepath_computeCppLibrary}'")
...
function(BUILD_SPIR exe_name spir_target_name source_file output_path)
    ...
    OUTPUT ${output_bc}
           ${output_stub}
    COMMAND ${filepath_computeCppCompiler}
